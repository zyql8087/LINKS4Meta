...
def main():
    ...
    for stage_cfg in stage_plan:
        ...
        selection_loader = val_loader if val_loader else (test_loader if test_loader else train_loader)
        ...
        final_val_metrics = eval_epoch_prebatched(policy, curve_encoder, val_loader, cfg) if val_loader else {}
        final_test_metrics = eval_epoch_prebatched(policy, curve_encoder, test_loader, cfg) if test_loader else {}
